...
def test_alhymrec_contact(browser_chrome, name, email, subject, message):
    ...
    sandwich_link = WebDriverWait(browser_chrome, 10).until(EC.element_to_be_clickable((By.CLASS_NAME, "sandwich-icon")))
    sandwich_link.click()
    contact_link = WebDriverWait(browser_chrome, 10).until(EC.element_to_be_clickable((By.LINK_TEXT, "CONTACT")))
    contact_link.click()
    contact_1_link = WebDriverWait(browser_chrome, 10).until(EC.element_to_be_clickable((By.LINK_TEXT, "CONTACT 1")))
    contact_1_link.click()
